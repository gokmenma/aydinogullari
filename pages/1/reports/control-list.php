...
<form method="POST" action="index.php?p=reports/control-list">
    <div class="pd-20 bg-white border-radius-16 box-shadow mb-30">
        <div class="clearfix">
            <div class="pull-left">
                <h4 class="text-blue">Cihaz Kontrol Listesi</h4>
                <p>Son kullanım tarihi gelmiş cihaz listesi</p>
        ...
        <div class="row">
            ...
            <div class="col-md-4 ">
                ...
                <div class="d-block w-100">
                    ...
                    <button type="button" id="control_list-toxls" class="btn btn-secondary">Excele Aktar</button>
...
<script>
$(document).on('click', '#control_list-toxls', function() {
    var month = $('#control_month').val();
    var year = $('#control_year').val();
    var url = '/pages/1/reports/ysc/control-list-export-toxls.php?month=' + month + '&year=' + year;
