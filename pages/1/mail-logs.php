...
<div class="pd-ltr-20 xs-pd-20-10">
	<div class="min-height-200px">
		...
		<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
			...
			<table class="data-table table-hover table-bordered text-nowrap">
				<thead>
					<tr>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td><?php echo $of["from_mail"]; ?></td>
							<td data-toggle="tooltip" data-tooltip="<?php echo $of["mail_body"]; ?>"><?php echo shorted($of["mail_body"], 21); ?></td>
							<td><?php echo $of["datest"]; ?></td>
							<td><?php echo $of["mail_file"]; ?></td>
							<td><?php echo getUsername($of["sender"]); ?></td>
