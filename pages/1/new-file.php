...
<div class="pd-20 bg-white border-radius-16 box-shadow mb-30">
	<div class="clearfix">
		...
		<div class="form-group">
			<button type="button" id="submitButton" onclick="validateForm()" class="float-right btn btn-primary btn-sm"><i class="fa fa-save"></i> Yükle</button>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-12">
				<div class="form-group">
					...
					data-style="border bg-white" data-header="Dosya Kategorileri">
						<?php
