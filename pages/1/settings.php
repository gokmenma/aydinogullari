...
if ($_POST) {
    ...
    header("Location: index.php?p=settings&id=$pid&st=newsuccess");
}
if (@$_GET["st"] == "newsuccess") {
    showAlert("success", "Ayarlar başarı ile kaydedildi!");
}
...
<form enctype="multipart/form-data" id="myform" action="index.php?p=settings" method="POST">
    ...
    <div class="pd-20 bg-white border-radius-16 box-shadow mb-30">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-10">
                <input required type="text" name="url" class="form-control" value="<?php echo set("panel_url"); ?>" />
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-10">
                <input required type="text" name="company" class="form-control"
                    value="<?php echo set("company_name"); ?>" />
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-12 col-md-2 col-form-label">Şirket Adres:</label>
            <div class="col-sm-12 col-md-10">
                <input required type="text" name="caddress" class="form-control"
                    value="<?php echo set("company_address"); ?>" />
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-10">
                <input required type="text" name="city" class="form-control"
                    value="<?php echo set("company_city"); ?>" />
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-12 col-md-2 col-form-label">Şirket Telefon 1:</label>
            <div class="col-sm-12 col-md-10">
                <input required type="text" name="gsm1" class="form-control"
                    value="<?php echo set("company_phone1"); ?>" />
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-12 col-md-2 col-form-label">Şirket Telefon 2:</label>
            <div class="col-sm-12 col-md-10">
                <input required type="text" name="gsm2" class="form-control"
                    value="<?php echo set("company_phone2"); ?>" />
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-12 col-md-2 col-form-label">
            ...
            <div class="col-sm-12 col-md-10">
                <input required type="text" name="mail_host" class="form-control"
                    value="<?php echo set("mail_host"); ?>" />
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-12 col-md-2 col-form-label">Gönderici Mail Kullanıcı Adı:</label>
            <div class="col-sm-12 col-md-10">
                <input required type="text" name="mail_username" class="form-control"
                    value="<?php echo set("mail_username"); ?>" />
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-10">
                <input required type="password" name="mail_password" class="form-control"
                    value="<?php echo set("mail_password"); ?>" />
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-10">
                <input required type="text" name="mail_port" class="form-control"
                    value="<?php echo set("mail_port"); ?>" />
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-12 col-md-2 col-form-label">Bilgilendirme Mail Alıcı:</label>
            <div class="col-sm-12 col-md-10">
                <input required type="text" name="mail_admin" class="form-control"
                    value="<?php echo set("admin_mail"); ?>" />
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-12 col-md-2 col-form-label">SMS Gönderimi (NetGSM)</label>
            <div class="col-sm-12 col-md-10">
                <input required type="checkbox" class="switch-btn"
                    <?php echo set("sms_active") == "on" ? "checked" : ""; ?> name="sms_active" data-color="#0059b2">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-10">
                <input type="text" name="sms_username" class="form-control"
                    value="<?php echo set("sms_username"); ?>" />
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-10">
                <input type="text" name="sms_title" class="form-control" value="<?php echo set("sms_title"); ?>" />
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-10">
                <input type="password" name="sms_pass" class="form-control" value="<?php echo set("sms_pass"); ?>" />
            </div>
        </div>
        <?php
        } ?>
