		...
		<div class="row">
			...
			<div class="col-sm-12 col-md-12">
				...
				<div class="form-group">
					<label>
						<font color="red">(*)</font>Yeni Kategori Adı:
					</label>
				...
				<tr>
					...
					<td>
						...
						&nbsp;&nbsp; <a onClick="return confirm('Silmek istediğinize emin misiniz?')"
							href="index.php?p=note-categories&mode=delete&code=04md177&md=active&xid=<?php echo $as["id"]; ?>"><span
								class="badge badge-danger">Sil</span></a></td>
