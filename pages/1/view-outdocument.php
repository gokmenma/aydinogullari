...
<div class="content pd-20 bg-white border-radius-16 box-shadow mb-30">
    ...
    <table id="tblOutDocuments" class="table-hover table-responsive-sm table-bordered data-table">
        <thead>
            <tr>
                <th>Sıra</th>
                <th>Firma</th>
        ...
        <tbody>
            ...
            while ($as = $cq->fetch(PDO::FETCH_ASSOC)) {
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $as["adet"] . "-" .$_SESSION["lid"]; ?>
                    </td>
                    <td class="text-center">

                        <?php
                        if ($as["teslimalan"] == $_SESSION["lid"] && ($as["e.teslimalmatarihi"] == "0000-00-00 00:00:00" || 
                                                                        $as["teslimalmatarihi"] == NULL || 
                                                                        $as["teslimalmatarihi"] == "" )) {
                            echo '<button class="btn btn-sm btn-success receive" data-id=' . $as["id"] . ' >Teslim Al</button>';
                        } else if ($as["teslimalmatarihi"] != null) {
                            echo $as["teslim_alan_username"];
                        } else {
                            echo 'Teslim Alınmayı Bekliyor';
                        }
                        ?>
                    ...
                    <td class="text-center text-nowrap col-md-1 pl-3 pr-3">
                        ...
                        <a href="#" class="btn btn-sm btn-danger" data-tooltip="Sil!"
                            onClick="deleteRecord('<?php echo $customer["company"]; ?>  isimli firmaya ait evrağı kaldırmak istediğinize emin misiniz?',<?php echo $as["id"]; ?>,'view-outdocument','evraktakip')">
