...
if ($_POST && $_GET["type"] == "update") {
	...
	regdate = ?,
	statu = ? WHERE id = ?", );
	$ekle->execute(array($title, TODAY . " - " . date("H:i:s") . "", 1, $id));
					...
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="exampleModalLongTitle">Birim</h5>
							...
							<div class="modal-body">
								<div class="form-group">
									...
									<label">
										...
										<input required id="title" name="title" autocomplete="off" placeholder="örn: Kg, Adet, Metre"
		...
		<tbody>
			...
			while ($as = $cq->fetch(PDO::FETCH_ASSOC)) {
				...
				<tr>
					...
					<td><?php echo getUsername($as["creator"]); ?></td>
					...
					<td>
						...
						<a class="btn btn-sm btn-danger text-white" data-tooltip="Sil"
							onClick="deleteRecord('Kaydı silmek istediğinize emin misiniz?',<?php echo $as["id"]; ?>,'define-units','units')"><i
